#' Title mymlbeta
#'
#' This function creates maximum likelihood estimations for a beta distribution. The function returns
#' a countour plot of all the maximum possibilities of the alpha and beta values.
#'
#' @param x - the sample data
#' @param alpha - the alpha value of the beta function
#' @param beta - the beta value of the beta function
#' @param ... - a spot for an additional paramater when creating the contour graph
#'
#' @return the maximum likelihood estimations for alpha and beta
#' @export
#'
#' @examples
